...
>
  <div className="ContainerModal w-full sm:w-2/3 md:w-1/3">
    <div className="flex items-center justify-center">
      <div className=""> {/* Modificado para ser responsivo */}
        ...
        >
          {({ setFieldValue, isSubmitting, handleSubmit }) => (
            <Form onSubmit={handleSubmit}>
              ...
              <Field type="number" className="Input" placeholder="Precio del producto" name="precio" />
              ...
              <Field type="number" className="Input" placeholder="Cantidad en inventario" name="cantidad" />
