...
import { PaymentModal } from "../../components/Metodo de Pago/PaymentModal";
...
export function HomePage() {
  ...
  return (
    <div className="main">
      ...
      <PaymentModal isOpen={isPaymentModalOpen} onClose={() => setIsPaymentModalOpen(false)} totalAmount={calculateInvoiceTotal()} />
    </div>
  );
}